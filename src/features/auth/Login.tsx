...
import { Eye, EyeOff, User, Lock, MessageCircle, ShieldCheck } from 'lucide-react';
...
export default function Login() {
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(err.response?.data?.error || err.message || 'Нэвтрэлт амжилтгүй. Дахин оролдоно уу.');
      setLoading(false);
    }
  };
        ...
        >
          <div className="relative bg-gray-900/80 dark:bg-black/60 backdrop-blur-xl p-6 sm:p-8 rounded-2xl shadow-2xl border border-white/5 dark:border-white/10 overflow-hidden rgb-border">
            ...
            <div className="text-center mb-6 sm:mb-10 relative z-10">
                ...
                <p className="text-blue-400 font-bold mt-1 tracking-widest uppercase text-[10px]">Contact Center System</p>
              </div>
              ...
              <div className="relative">
                {!isForgotPassword ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-gray-400 text-sm mb-6">Бүртгэлтэй и-мэйл хаягаа оруулан нууц үг сэргээх холбоос хүлээн авна уу.</p>
                       ...
                       <input
                        ...
                        />
                         <button
                          ...
                          onClick={() => alert('Сэргээх и-мэйл илгээгдлээ. (Azure Communication Services demo)')}
                        >
                          Илгээх
                        </button>
                        <button 
